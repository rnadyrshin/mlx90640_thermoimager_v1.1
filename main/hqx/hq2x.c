...
void hq2x_32_rb(int16_t * sp, uint32_t srb, int16_t * dp, uint32_t drb, int Xres, int Yres )
{
    int i, j, k;
...
void hq2x_32(int16_t * sp, int16_t * dp, int Xres, int Yres )
{
    uint32_t rowBytesL = Xres * sizeof(int16_t);
